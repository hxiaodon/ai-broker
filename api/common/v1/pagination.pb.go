...
type PageRequest struct {
	...
	PageSize      int32                  `protobuf:"varint,2,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"` // 每页条数，最大 100
...
type PageResponse struct {
	...
	Total         int32                  `protobuf:"varint,3,opt,name=total,proto3" json:"total,omitempty"` // 总条数
...
const file_common_v1_pagination_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/v1/pagination.proto\x12\x13brokerage.common.v1\">\n" +
	...
	"\bhas_next\x18\x04 \x01(\bR\ahasNextB6Z4github.com/hxiaodon/ai-broker/api/common/v1;commonv1b\x06proto3"
...
var file_common_v1_pagination_proto_goTypes = []any{
	(*PageRequest)(nil),  // 0: brokerage.common.v1.PageRequest
	(*PageResponse)(nil), // 1: brokerage.common.v1.PageResponse
}
