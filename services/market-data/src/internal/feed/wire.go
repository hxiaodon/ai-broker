...
// ProvideWorker provides a feed worker.
func ProvideWorker(client *MassiveClient, updateQuote *app.UpdateQuoteUsecase, logger *zap.Logger) *Worker {
	return NewWorker(client, updateQuote, logger)
}
