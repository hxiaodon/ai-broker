...
type Order struct {
    ...
    // Audit
    Source        string          // "MOBILE_IOS" / "MOBILE_ANDROID" / "WEB" / "API"
    IPAddress     string
    DeviceID      string
}
```
...
- Notify fund-transfer-engineer when settled cash is available for withdrawal
...
CREATE TABLE order_events (
    ...
    event_type      TEXT NOT NULL,           -- 'CREATED' / 'VALIDATED' / 'RISK_APPROVED' / 'SUBMITTED' / 'FILLED' / ...
...
- **Database**: `jackc/pgx` with connection pooling
