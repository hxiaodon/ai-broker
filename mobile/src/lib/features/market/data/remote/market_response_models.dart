...
abstract class StockDetailDto with _$StockDetailDto {
  const factory StockDetailDto({
    ...
    @JsonKey(name: 'pe_ratio') @Default('') String peRatio,
    @JsonKey(name: 'pb_ratio') @Default('') String pbRatio,
    @JsonKey(name: 'dividend_yield') @Default('') String dividendYield,
    @JsonKey(name: 'shares_outstanding') @Default(0) int sharesOutstanding,
    @JsonKey(name: 'avg_volume') @Default(0) int avgVolume,
    @JsonKey(name: 'week_52_high') @Default('') String week52High,
    @JsonKey(name: 'week_52_low') @Default('') String week52Low,
    @JsonKey(name: 'turnover_rate') @Default('') String turnoverRate,
