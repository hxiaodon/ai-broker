...
_StockDetailDto _$StockDetailDtoFromJson(Map<String, dynamic> json) =>
    _StockDetailDto(
      ...
      sharesOutstanding: (json['shares_outstanding'] as num?)?.toInt() ?? 0,
      avgVolume: (json['avg_volume'] as num?)?.toInt() ?? 0,
      week52High: json['week_52_high'] as String? ?? '',
      week52Low: json['week_52_low'] as String? ?? '',
...
Map<String, dynamic> _$StockDetailDtoToJson(_StockDetailDto instance) =>
    <String, dynamic>{
      ...
      'week_52_high': instance.week52High,
      'week_52_low': instance.week52Low,
