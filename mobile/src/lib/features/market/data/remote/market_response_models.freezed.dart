...
mixin _$StockDetailDto {
 ...
 String get symbol; String get name;@JsonKey(name: 'name_zh') String get nameZh; String get market; String get price; String get change;@JsonKey(name: 'change_pct') String get changePct; String get open; String get high; String get low;@JsonKey(name: 'prev_close') String get prevClose; int get volume; String get turnover; String? get bid; String? get ask; bool get delayed;@JsonKey(name: 'market_status') String get marketStatus; String get session;@JsonKey(name: 'is_stale') bool get isStale;@JsonKey(name: 'stale_since_ms') int get staleSinceMs;// Fundamental fields (optional for Mock Server compatibility)
@JsonKey(name: 'market_cap') String get marketCap;@JsonKey(name: 'pe_ratio') String get peRatio;@JsonKey(name: 'pb_ratio') String get pbRatio;@JsonKey(name: 'dividend_yield') String get dividendYield;@JsonKey(name: 'shares_outstanding') int get sharesOutstanding;@JsonKey(name: 'avg_volume') int get avgVolume;@JsonKey(name: 'week_52_high') String get week52High;@JsonKey(name: 'week_52_low') String get week52Low;@JsonKey(name: 'turnover_rate') String get turnoverRate; String get exchange; String get sector;@JsonKey(name: 'as_of') String get asOf;
...
class _StockDetailDto implements StockDetailDto {
  const _StockDetailDto({required this.symbol, required this.name, @JsonKey(name: 'name_zh') required this.nameZh, required this.market, required this.price, required this.change, @JsonKey(name: 'change_pct') required this.changePct, required this.open, required this.high, required this.low, @JsonKey(name: 'prev_close') required this.prevClose, required this.volume, required this.turnover, this.bid, this.ask, required this.delayed, @JsonKey(name: 'market_status') required this.marketStatus, this.session = '', @JsonKey(name: 'is_stale') this.isStale = false, @JsonKey(name: 'stale_since_ms') this.staleSinceMs = 0, @JsonKey(name: 'market_cap') this.marketCap = '', @JsonKey(name: 'pe_ratio') this.peRatio = '', @JsonKey(name: 'pb_ratio') this.pbRatio = '', @JsonKey(name: 'dividend_yield') this.dividendYield = '', @JsonKey(name: 'shares_outstanding') this.sharesOutstanding = 0, @JsonKey(name: 'avg_volume') this.avgVolume = 0, @JsonKey(name: 'week_52_high') this.week52High = '', @JsonKey(name: 'week_52_low') this.week52Low = '', @JsonKey(name: 'turnover_rate') this.turnoverRate = '', this.exchange = '', this.sector = '', @JsonKey(name: 'as_of') this.asOf = ''});
...
@override final  bool delayed;
@override@JsonKey(name: 'market_status') final  String marketStatus;
@override@JsonKey() final  String session;
@override@JsonKey(name: 'is_stale') final  bool isStale;
@override@JsonKey(name: 'stale_since_ms') final  int staleSinceMs;
// Fundamental fields (optional for Mock Server compatibility)
@override@JsonKey(name: 'market_cap') final  String marketCap;
@override@JsonKey(name: 'pe_ratio') final  String peRatio;
...
@override@JsonKey(name: 'week_52_high') final  String week52High;
@override@JsonKey(name: 'week_52_low') final  String week52Low;
