...
/// @nodoc
mixin _$InvestmentAssessmentState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is InvestmentAssessmentState);
}
...
@override
String toString() {
  return 'InvestmentAssessmentState()';
}
...
/// @nodoc
class $InvestmentAssessmentStateCopyWith<$Res>  {
$InvestmentAssessmentStateCopyWith(InvestmentAssessmentState _, $Res Function(InvestmentAssessmentState) __);
}


/// Adds pattern-matching-related methods to [InvestmentAssessmentState].
extension InvestmentAssessmentStatePatterns on InvestmentAssessmentState {
...
class _Idle implements InvestmentAssessmentState {
  const _Idle();
...
@override
String toString() {
  return 'InvestmentAssessmentState.idle()';
}
...
class _Submitting implements InvestmentAssessmentState {
  const _Submitting();
...
@override
String toString() {
  return 'InvestmentAssessmentState.submitting()';
}
...
class _Success implements InvestmentAssessmentState {
  const _Success();
...
@override
String toString() {
  return 'InvestmentAssessmentState.success()';
}
...
class _Error implements InvestmentAssessmentState {
  const _Error({required this.message});
  

 final  String message;

/// Create a copy of InvestmentAssessmentState
...
@override
String toString() {
  return 'InvestmentAssessmentState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $InvestmentAssessmentStateCopyWith<$Res> {
