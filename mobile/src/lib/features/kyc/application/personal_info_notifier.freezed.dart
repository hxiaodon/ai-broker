...
class _Idle implements PersonalInfoState {
  const _Idle();
...
class _Submitting implements PersonalInfoState {
  const _Submitting();
...
@override
String toString() {
  return 'PersonalInfoState.submitting()';
}
...
class _Success implements PersonalInfoState {
  const _Success();
...
@override
String toString() {
  return 'PersonalInfoState.success()';
}
...
class _Error implements PersonalInfoState {
...
@override
String toString() {
  return 'PersonalInfoState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $PersonalInfoStateCopyWith<$Res> {
