...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TaxFormState);
}
...
/// @nodoc
class $TaxFormStateCopyWith<$Res>  {
$TaxFormStateCopyWith(TaxFormState _, $Res Function(TaxFormState) __);
}


/// Adds pattern-matching-related methods to [TaxFormState].
extension TaxFormStatePatterns on TaxFormState {
...
class _Idle implements TaxFormState {
  const _Idle();
...
class _Submitting implements TaxFormState {
  const _Submitting();
...
@override
String toString() {
  return 'TaxFormState.submitting()';
}
...
class _Success implements TaxFormState {
  const _Success();
...
class _Error implements TaxFormState {
  const _Error({required this.message});
  

 final  String message;

/// Create a copy of TaxFormState
...
@override
String toString() {
  return 'TaxFormState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $TaxFormStateCopyWith<$Res> {
