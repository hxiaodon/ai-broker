...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FinancialProfileState);
}
...
/// @nodoc
class $FinancialProfileStateCopyWith<$Res>  {
$FinancialProfileStateCopyWith(FinancialProfileState _, $Res Function(FinancialProfileState) __);
}


/// Adds pattern-matching-related methods to [FinancialProfileState].
extension FinancialProfileStatePatterns on FinancialProfileState {
...
class _Idle implements FinancialProfileState {
  const _Idle();
...
@override
String toString() {
  return 'FinancialProfileState.idle()';
}
...
class _Submitting implements FinancialProfileState {
  const _Submitting();
...
@override
String toString() {
  return 'FinancialProfileState.submitting()';
}
...
class _Success implements FinancialProfileState {
  const _Success();
...
@override
String toString() {
  return 'FinancialProfileState.success()';
}
...
class _Error implements FinancialProfileState {
  const _Error({required this.message});
  

 final  String message;

/// Create a copy of FinancialProfileState
...
@override
String toString() {
  return 'FinancialProfileState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $FinancialProfileStateCopyWith<$Res> {
