...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DepositFormState);
}
...
/// @nodoc
class $DepositFormStateCopyWith<$Res>  {
$DepositFormStateCopyWith(DepositFormState _, $Res Function(DepositFormState) __);
}


/// Adds pattern-matching-related methods to [DepositFormState].
extension DepositFormStatePatterns on DepositFormState {
...
class _Idle implements DepositFormState {
  const _Idle();
...
class _Confirming implements DepositFormState {
...
/// Create a copy of DepositFormState
...
@override
String toString() {
  return 'DepositFormState.confirming(amount: $amount, bankAccountId: $bankAccountId, channel: $channel)';
}
...
/// @nodoc
abstract mixin class _$ConfirmingCopyWith<$Res> implements $DepositFormStateCopyWith<$Res> {
...
class _Submitting implements DepositFormState {
  const _Submitting();
...
@override
String toString() {
  return 'DepositFormState.submitting()';
}
...
class _Success implements DepositFormState {
...
@override
String toString() {
  return 'DepositFormState.success(transferId: $transferId)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $DepositFormStateCopyWith<$Res> {
...
class _Error implements DepositFormState {
...
@override
String toString() {
  return 'DepositFormState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $DepositFormStateCopyWith<$Res> {
