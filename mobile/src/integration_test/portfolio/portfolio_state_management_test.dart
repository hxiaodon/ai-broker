...
void main() {
  ...
  group('Portfolio Module - App States', () {
    testWidgets(
      ...
      (tester) async {
        ...
        printOnFailure('✅ TP1: Authenticated state renders portfolio-capable app');
      },
    );
  });
  ...
  group('Portfolio Module - Provider Loading States', () {
    ...
    test('TP2: positionsProvider loads 2 positions (AAPL + 0700)', () async {
      ...
      printOnFailure('✅ TP2: positionsProvider loaded ${positions.length} positions');
    });
  ...
  group('Portfolio Module - Empty Portfolio States', () {
    test(
      ...
      () async {
        ...
        printOnFailure('✅ TP11: Empty portfolio state verified');
      },
    );
  ...
  group('Portfolio Module - Edge Cases & Invariants', () {
    ...
    test(
      ...
      () async {
        ...
        printOnFailure('✅ TP15: Equal P&L stable sort: $symbols');
      },
    );
    ...
    test(
      ...
      () async {
        ...
        printOnFailure('✅ TP16: All-negative market values → empty allocation list');
      },
    );
    ...
    test(
      ...
      () async {
        ...
        printOnFailure('✅ TP17: portfolioRepositoryProvider rebuilt after invalidation');
      },
    );
  });
}
...
class _StubSessionKeyService extends SessionKeyService {
  ...
  Future<SessionKey> getSessionKey() async =>
      (keyId: 'sk-stub-001', secret: 'STUB_NOT_A_REAL_SECRET');
